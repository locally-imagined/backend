...
// Client lists the signup service endpoint HTTP clients.
type Client struct {
...
// NewClient instantiates HTTP clients for all the signup service servers.
func NewClient(
	scheme string,
	host string,
	doer goahttp.Doer,
...
// Signup returns an endpoint that makes HTTP requests to the signup service
// Signup server.
func (c *Client) Signup() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("signup", "Signup", err)
		}
