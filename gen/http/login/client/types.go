...
// HTTP "OK" response.
func NewLoginResultOK(body string, accessControlAllowHeaders *string, accessControlAllowOrigin *string, accessControlAllowCredentials *string) *login.LoginResult {
	v := body
