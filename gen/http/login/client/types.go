...
// HTTP "OK" response.
func NewLoginResultOK(body string, accessControlAllowMethods *string, accessControlAllowOrigin *string, accessControlAllowCredentials *string) *login.LoginResult {
	v := body
